$(function () {
	...
	*/
	...
	$("form select.styled_short").select_skin();
	$("form select.styled_long").select_skin();
	...
	*/
	...
	/*$("#tab_link_1").bind("click", function(){
	...
	$("#tab_link_2").bind("click", function(){$(".sidebar_content").hide(); $("#sb2").show(); $(".sidemenu li").removeClass("active");$(this).parent().addClass("active");});
	$("#tab_link_3").bind("click", function(){$(".sidebar_content").hide(); $("#sb3").show(); $(".sidemenu li").removeClass("active");$(this).parent().addClass("active");});*/
